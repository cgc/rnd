...
Scenario: Shading an intersection
  Given w ← default_world()
    And r ← ray(point(0, 0, -5), vector(0, 0, 1))
    And shape ← the first object in w immutable
...
Scenario: Shading an intersection from the inside
  Given w ← default_world()
    ...
    And shape ← the second object in w immutable
...
Scenario: The color with an intersection behind the ray
  Given w ← default_world()
    ...
    And exp_c ← inner.material.color
  When c ← color_at(w, r)
...
Scenario: The reflected color for a nonreflective material
  ...
  When comps ← prepare_computations(i, r)
  # Changes by cgc: Here + below, var names of color to c to avoid collisions
...
Scenario: The refracted color with a refracted ray
  Given w ← default_world()
    ...
    And B has:
      | material.transparency     | 1.0 |
      | material.refractive_index | 1.5 |
    # adding for borrow checker
    And A ← the first object in w immutable
    And B ← the second object in w immutable
